...
public class DepartmentController {
	...
	public String create(Model model) {
		model.addAttribute("department", new Department()); // tai sao lai them model moi ??? them han new department
		return "department/create";
	}

	@PostMapping("/create")
	public String create(@ModelAttribute("department") @Valid Department department, BindingResult bindingResult) { //model attribute=> add thang vao doi tuong
//validation chi ap dung cho modelattribute, ko ap dung cho requestparam
